...
- **Live data integration**: a Stories feature that fetches, creates, and displays real data from an external REST API (SMS Express), demonstrating Server Components, dynamic routes, and client-side forms
  - `/get-all-stories` — lists all stories fetched live from the API
  - `/create-story` — client-side form to submit a new story
  - `/[id]` — dynamic route showing a single story's details
### Bonus Features
...
- **TypeScript**
- **Tailwind CSS**
- **SMS Express REST API** (external data source for the Stories feature)
---
## Setup Instructions
### 1. Clone the repository
```bash
git clone <https://github.com/Umutoni123-aa/my-learning-journey>
...
│   ├── get-all-stories/
│   │   └── page.tsx            # "/get-all-stories" — lists live stories from the API
│   ├── create-story/
│   │   └── page.tsx            # "/create-story" — form to submit a new story
│   └── [id]/
│       └── page.tsx            # "/[id]" — dynamic story detail page
│
├── components/
...
│
├── lib/
│   ├── story.ts                 # Story and CreateStoryDTO type definitions
│   └── api.ts                    # API functions (getStories, getStory, createStory, updateStory, deleteStory)
│
